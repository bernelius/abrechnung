...
class RecipientManagerTest {
    ...
    @Test
    fun `changeCompanyName blank then blank then valid shows two errors`() =
        runBlocking {
            val scene = MockScene()
            val manager = createManager(MockReader("", "", "NewCompany"))
    ...
    @Test
    fun `changeCompanyName duplicate name is blocked`() =
        runBlocking {
    ...
    @Test
    fun `changeEmail blank input shows error`() =
        runBlocking {
            val scene = MockScene()
            val manager = createManager(MockReader("", "recipient@example.com"))
    ...
    @Test
    fun `changeEmail invalid format shows error`() =
        runBlocking {
            val scene = MockScene()
    ...
    @Test
    fun `changeOrgNumber valid input updates dto`() =
        runBlocking {
            val scene = MockScene()
    ...
    @Test
    fun `changeOrgNumber blank input updates dto with empty string`() =
        runBlocking {
            val scene = MockScene()
    ...
    @Test
    fun `changeOrgNumber duplicate number is blocked`() =
        runBlocking {
            val scene = MockScene()
