...
class RepositoryTest {
    ...
    @Test
    fun `addRecipient returns id and can be retrieved`() =
        runBlocking {
            val recipient =
                RecipientDTO(
    ...
    @Test
    fun `updateRecipient modifies existing record`() =
        runBlocking {
            val id =
    ...
    @Test
    fun `findAllRecipientsSortFrequency returns all recipients`() =
        runBlocking {
    ...
    @Test
    fun `findRecipientByIdOrNull returns null for nonexistent`() =
        runBlocking {
            assertNull(Repository.findRecipientByIdOrNull(99999))
        }

    @Test
    fun `saveInvoice and findInvoiceById`() =
        runBlocking {
            val recipientId =
                Repository.addRecipient(
    ...
    @Test
    fun `markInvoiceAsPaid changes status`() =
        runBlocking {
            val recipientId =
                Repository.addRecipient(
                    RecipientDTO(companyName = "Client", address = "St", postal = "1", email = "c@c.com"),
    ...
    @Test
    fun `findAllInvoices can filter by status`() =
        runBlocking {
            val recipientId =
                Repository.addRecipient(
                    RecipientDTO(companyName = "Client", address = "St", postal = "1", email = "c@c.com"),
    ...
    @Test
    fun `setUserConfig and getUserConfig`() =
        runBlocking {
            val config =
                UserConfigDTO(
                    name = "John Doe",
    ...
    @Test
    fun `getUserConfig returns default when not set`() =
        runBlocking {
    ...
    @Test
    fun `findAllRecipientsSortFrequency orders by invoice count`() =
        runBlocking {
